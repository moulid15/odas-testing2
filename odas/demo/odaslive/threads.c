    ...
    void threads_multiple_start(aobjects * aobjs) {
        ...
        // +----------------------------------------------------------+  
            ...
            // +------------------------------------------------------+                     
                ...
                if (enablePFS == 0x01) thread_start(aobjs->acon_spectra_pfs_object->thread);
        ...
        // +----------------------------------------------------------+  
            ...
            // +------------------------------------------------------+  
                ...
                if (enablePFS == 0x01) thread_start(aobjs->amod_istft_pfs_object->thread);
            ...
            // +------------------------------------------------------+  
                ...
                if (enablePFS == 0x01) thread_start(aobjs->acon_hops_pfs_object->thread);
        ...
        // +------------------------------------------------------+  
            ...
            // +--------------------------------------------------+  
                ...
                if (enablePFS == 0x01) thread_start(aobjs->amod_resample_pfs_object->thread);
            ...
            // +--------------------------------------------------+  
                ...
                if (enablePFS == 0x01) thread_start(aobjs->acon_hops_pfs_rs_object->thread);
        ...
        // +------------------------------------------------------+  
            ...
            // +--------------------------------------------------+  
                ...
                if (enablePFS == 0x01) thread_start(aobjs->amod_volume_pfs_object->thread);
            ...
            // +--------------------------------------------------+                     
                ...
                if (enablePFS == 0x01) thread_start(aobjs->asnk_hops_pfs_vol_object->thread);
            ...
            // +--------------------------------------------------+  
                ...
                if (enablePFS == 0x01) thread_start(aobjs->acon_hops_pfs_vol_object->thread);
    ...
    void threads_multiple_join(aobjects * aobjs) {
        ...
        // +----------------------------------------------------------+  
            ...
            // +------------------------------------------------------+  
                ...
                if (enablePFS == 0x01) thread_join(aobjs->acon_spectra_pfs_object->thread);
        ...
        // +----------------------------------------------------------+  
            ...
            // +------------------------------------------------------+  
                ...
                if (enablePFS == 0x01) thread_join(aobjs->amod_istft_pfs_object->thread);
            ...
            // +------------------------------------------------------+  
                ...
                if (enablePFS == 0x01) thread_join(aobjs->acon_hops_pfs_object->thread);
        ...
        // +------------------------------------------------------+  
            ...
            // +--------------------------------------------------+  
                ...
                if (enablePFS == 0x01) thread_join(aobjs->amod_resample_pfs_object->thread);
            ...
            // +--------------------------------------------------+  
                ...
                if (enablePFS == 0x01) thread_join(aobjs->acon_hops_pfs_rs_object->thread);
        ...
        // +------------------------------------------------------+  
            ...
            // +--------------------------------------------------+  
                ...
                if (enablePFS == 0x01) thread_join(aobjs->amod_volume_pfs_object->thread);
            ...
            // +--------------------------------------------------+                     
                ...
                if (enablePFS == 0x01) thread_join(aobjs->asnk_hops_pfs_vol_object->thread);
            ...
            // +--------------------------------------------------+  
                ...
                if (enablePFS == 0x01) thread_join(aobjs->acon_hops_pfs_vol_object->thread);
    ...
    void threads_single_open(objects * objs) {
        ...
        // +----------------------------------------------------------+  
            ...
            // +------------------------------------------------------+                      
                ...
                if (enablePFS == 0x01) snk_hops_open(objs->snk_hops_pfs_vol_object);
    ...
    void threads_single_close(objects * objs) {
        ...
        // +----------------------------------------------------------+  
            ...
            // +------------------------------------------------------+                      
                ...
                if (enablePFS == 0x01) snk_hops_close(objs->snk_hops_pfs_vol_object);                
